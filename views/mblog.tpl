...
<link type="text/css" rel="stylesheet" href="/static/mblog.css" media="screen" />
</head>
<body>
<header><nav>
	<ul>
...
<nav>
	%if not num:
		<a id="nav_prev" href="#">Previous</a>
	%else:
		<a id="nav_prev" href="/show/{{ num-1 }}">Previous</a>
	%end
	<a id="nav_next" href="/show/{{ num+1 }}">Next</a>
</nav>
</footer>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script type="text/javascript" src="/static/jquery.form.js"></script>
<script type="text/javascript" src="/static/mblog.js"></script>
